...
s_input_data = st.text_input("Sender")
r_input_data = st.text_input("Receiver")
a_input_data = st.text_input("Amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record = Record(s_input_data, r_input_data, a_input_data),
        creator_id=42,
